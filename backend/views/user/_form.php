...
<div class="container user-form p-3">
    ...
    <div class="row pb-3">
        <div class="col-12 col-sm-2 col-md-3 col-lg-3">
            <h4><?= Yii::t('app', 'Name') ?> <sup class="fill-red fs-6">(*)</sup></h4>
        </div>
    ...
    <div class="row pb-3">
        <div class="col-12 col-sm-2 col-md-3 col-lg-3">
            <h4><?= Yii::t('app', 'Email') ?> <sup class="fill-red fs-6">(*)</sup></h4>
        </div>
        <div class="col-12 col-sm-6 col-md-5 col-lg-6">
    ...
    <div class="row pb-3">
        <div class="col-12 col-sm-2 col-md-3 col-lg-3">
            <h4><?= Yii::t('app', 'Password') ?> <sup class="fill-red fs-6">(*)</sup>
            </h4>
        </div>
        <div class="col-12 col-sm-6 col-md-5 col-lg-6">
    ...
    <div class="row pb-3">
        <div class="col-12 col-sm-2 col-md-3 col-lg-3">
            <h4><?= Yii::t('app', 'Role') ?> <sup class="fill-red fs-6">(*)</sup></h4>
        </div>
        <div class="col-12 col-sm-6 col-md-5 col-lg-6">
